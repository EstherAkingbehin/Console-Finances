...
//4
var greatest_increase = finances[1][1]; // Initialize with the second element
var greatest_increase_date = finances[1][0]; 

for (var i = 2; i < finances.length; i++) {
  var current_change = finances[i][1] - finances[i - 1][1];
...
console.log(`Greatest Increase in Profits/Losses: ${greatest_increase_date} ($${greatest_increase})`);

//5

var greatest_decrease = finances[1][1];
var greatest_decrease_date = finances[1][0]; 
...
for (var i = 2; i < finances.length; i++) {
  ...
  if (current_change < greatest_decrease) {
    ...
    greatest_decrease_date = finances[i][0];
  }
}

console.log(`Greatest Decrease in Profits/Losses: ${greatest_decrease_date} ($${greatest_decrease})`)
